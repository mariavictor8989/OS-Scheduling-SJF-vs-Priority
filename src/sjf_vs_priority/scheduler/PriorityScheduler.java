 ...
 */
package sjf_vs_priority.scheduler;

import sjf_vs_priority.model.GanttBlock;
import sjf_vs_priority.model.SimulationResult;
import sjf_vs_priority.model.Process;
...
public class PriorityScheduler {
    ...
    private final boolean lowerIsBetter; // true = lower number = higher priority

    public PriorityScheduler(List<Process> processes, boolean lowerIsBetter) {
    ...
    public SimulationResult run() {
        ...
        while (completed.size() < copies.size()) {
            ...
            // sort by priority, tie: earliest arrival, tie: pid lex
            Comparator<Integer> cmp = lowerIsBetter
                ? Comparator.comparingInt((Integer i) -> copies.get(i).priority)
                : Comparator.comparingInt((Integer i) -> -copies.get(i).priority);
            cmp = cmp.thenComparingInt(i -> copies.get(i).arrivalTime)
